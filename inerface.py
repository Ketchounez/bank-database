...
class App(ctk.CTk):
    ...
    def init_menu_frame(self):
        ...
        self.credit_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.clients_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.employees_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.contracts_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.payments_button.configure(width=200, height=50, font=("Arial", 30))
    ...
    def init_credit_state_frame(self):
        ...
        self.credit1_button.grid(row=0, column=0, padx=300, pady=10, sticky="nsew")
        self.credit1_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.credit2_button.grid(row=1, column=0, padx=300, pady=10, sticky="nsew")
        self.credit2_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.credit3_button.grid(row=2, column=0, padx=300, pady=10, sticky="nsew")
        self.credit3_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.credit4_button.grid(row=3, column=0, padx=300, pady=10, sticky="nsew")
        self.credit4_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.credit5_button.grid(row=4, column=0, padx=300, pady=10, sticky="nsew")
        self.credit5_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.credit6_button.grid(row=5, column=0, padx=300, pady=10, sticky="nsew")
        self.credit6_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.back_button_credit.configure(width=200, height=50, font=("Arial", 30))
    ...
    def init_client_state_frame(self):
        ...
        self.client1_button.grid(row=0, column=0, padx=300, pady=10, sticky="nsew")
        self.client1_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.client2_button.grid(row=1, column=0, padx=300, pady=10, sticky="nsew")
        self.client2_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.client3_button.grid(row=2, column=0, padx=300, pady=10, sticky="nsew")
        self.client3_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.client4_button.grid(row=3, column=0, padx=300, pady=10, sticky="nsew")
        self.client4_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.client5_button.grid(row=4, column=0, padx=300, pady=10, sticky="nsew")
        self.client5_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.client6_button.grid(row=5, column=0, padx=300, pady=10, sticky="nsew")
        self.client6_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.back_button_client.configure(width=200, height=50, font=("Arial", 30))
    ...
    def init_employee_state_frame(self):
        ...
        self.employee1_button.grid(row=0, column=0, padx=300, pady=10, sticky="nsew")
        self.employee1_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.employee2_button.grid(row=1, column=0, padx=300, pady=10, sticky="nsew")
        self.employee2_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.employee3_button.grid(row=2, column=0, padx=300, pady=10, sticky="nsew")
        self.employee3_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.employee4_button.grid(row=3, column=0, padx=300, pady=10, sticky="nsew")
        self.employee4_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.employee5_button.grid(row=4, column=0, padx=300, pady=10, sticky="nsew")
        self.employee5_button.configure(width=200, height=50, font=("Arial", 30))


        # Кнопка "Назад"
        self.back_button_employee = ctk.CTkButton(self.employee_state_frame, text="Назад",
                                                  command=self.show_menu, fg_color="grey")
        self.back_button_employee.grid(row=5, column=0, padx=300, pady=10, sticky="nsew")
        self.back_button_employee.configure(width=200, height=50, font=("Arial", 30))
    ...
    def init_contracts_state_frame(self):
        ...
        self.contracts1_button.grid(row=0, column=0, padx=300, pady=10, sticky="nsew")
        self.contracts1_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.contracts2_button.grid(row=1, column=0, padx=300, pady=10, sticky="nsew")
        self.contracts2_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.contracts3_button = ctk.CTkButton(self.contracts_state_frame,
                                               ...
                                               command=lambda: self.show_result_state(fn.credits_command_third))
        self.contracts3_button.grid(row=2, column=0, padx=300, pady=10, sticky="nsew")
        self.contracts3_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.contracts4_button.grid(row=3, column=0, padx=300, pady=10, sticky="nsew")
        self.contracts4_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.contrasts5_button.grid(row=4, column=0, padx=300, pady=10, sticky="nsew")
        self.contrasts5_button.configure(width=200, height=50, font=("Arial", 30))


        # Кнопка "Назад"
        self.back_button_contracts = ctk.CTkButton(self.contracts_state_frame, text="Назад",
                                                   command=self.show_menu, fg_color="grey")
        self.back_button_contracts.grid(row=5, column=0, padx=300, pady=10, sticky="nsew")
        self.back_button_contracts.configure(width=200, height=50, font=("Arial", 30))
    ...
    def init_payments_state_frame(self):
        ...
        self.payment1_button.grid(row=0, column=0, padx=300, pady=10, sticky="nsew")
        self.payment1_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.payment2_button.grid(row=1, column=0, padx=300, pady=10, sticky="nsew")
        self.payment2_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.payment3_button.grid(row=2, column=0, padx=300, pady=10, sticky="nsew")
        self.payment3_button.configure(width=200, height=50, font=("Arial", 30))

        # Кнопка "Платеж 4"
        self.payments4_button = ctk.CTkButton(self.payments_state_frame,
                                              text="Отчет по погашениям",
                                              command=lambda: self.show_result_state(fn.payments_command_fourth))
        self.payments4_button.grid(row=3, column=0, padx=300, pady=10, sticky="nsew")
        self.payments4_button.configure(width=200, height=50, font=("Arial", 30))
        ...
        self.payments5_button.grid(row=4, column=0, padx=300, pady=10, sticky="nsew")
        self.payments5_button.configure(width=200, height=50, font=("Arial", 30))

        # Кнопка "Назад"
        self.back_button_payments = ctk.CTkButton(self.payments_state_frame, text="Назад",
                                                  command=self.show_menu, fg_color="grey")
        self.back_button_payments.grid(row=5, column=0, padx=300, pady=10, sticky="nsew")
        self.back_button_payments.configure(width=200, height=50, font=("Arial", 30))
    ...
    def show_credit_state(self):
        self.hide_all_states()
        self.credit_state_frame.grid(row=0, column=0, padx=self.winfo_screenwidth() / 7, pady=220, sticky="nsew")
    ...
    def show_employee_state(self):
        self.hide_all_states()
        self.employee_state_frame.grid(row=0, column=0, padx=self.winfo_screenwidth() / 7, pady=220, sticky="nsew")
    ...
    def show_contracts_state(self):
        self.hide_all_states()
        self.contracts_state_frame.grid(row=0, column=0, padx=self.winfo_screenwidth() / 15, pady=220, sticky="nsew")
    ...
    def show_payments_state(self):
        self.hide_all_states()
        self.payments_state_frame.grid(row=0, column=0, padx=self.winfo_screenwidth() / 14, pady=220, sticky="nsew")
